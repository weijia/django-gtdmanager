...
urlpatterns = patterns('',
    ...
    url(r'^project/(?P<project_id>\d+)/delete/(?P<redir_page>\w+)$', views.project_delete, name='project_delete'),
    url(r'^project/(?P<project_id>\d+)/delete/(?P<redir_page>\w+)/(?P<redir_id>\d+)$', views.project_delete_redir_id, name='project_delete_redir_id'),
    url(r'^project/(?P<project_id>\d+)/complete/(?P<redir_page>\w+)$', views.project_complete, name='project_complete'),
    url(r'^project/(?P<project_id>\d+)/complete/(?P<redir_page>\w+)/(?P<redir_id>\d+)$', views.project_complete_redir_id, name='project_complete_redir_id'),
