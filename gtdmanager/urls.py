...
urlpatterns = patterns('',
    ...
    url(r'^item/(?P<item_id>\d+)/reference$', ajax.item_reference, name='item_reference'),
    url(r'^item/(?P<item_id>\d+)/someday$', ajax.item_someday, name='item_someday'),
    url(r'^item/(?P<item_id>\d+)/waitfor$', ajax.item_waitfor, name='item_waitfor'),
    url(r'^item/(?P<item_id>\d+)/toproject$', ajax.item_toproject, name='item_toproject'),
